...
no tiene para que el nodo local haga un direc request de string o de multiples variables
*/

/**Hacer fullfill funcion virtual para sobreeescribirla y continuar haciendo operaciones despues de llenar el string*/
